{
 ...
 fsm.SetBaseOutDir("/volatile/clas12/matthewn/Scaling_Strangeness_Output_RGA_FALL2018_Outbending_test_16022022_01/");
  ////Connect the data to the manager
  fsm.LoadData(&hdata);

  ////load one or more FinalStates
  fsm.LoadFinalState("Scaling_Strangeness",
		     "Configurations/ALLALL_electron_Start_Time_ElectronFD_Strangeness.root");
  // fsm.LoadFinalState("Scaling_Strangeness",
