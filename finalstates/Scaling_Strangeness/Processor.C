{
  ...
  // chain.Add("/home/matthewn/links/RGA_Fall_2018_Outbending_dst/*.hipo");
   chain.Add("/home/matthewn/links/RGA_Fall_2018_Outbending_dst/rec_clas_005432.evio.010*.hipo");
  // for(int i=0;i<100;i++)
  ...
  chanser::HipoProcessor processor(&chain,"finalstate.txt","/volatile/clas12/matthewn/Scaling_Strangeness_Output_RGA_FALL2018_Outbending_5432_01_18022022_01");
